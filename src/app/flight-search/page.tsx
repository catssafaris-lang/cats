...
const routes = [
  ...
  { city: 'Frankfurt', code: 'FRA', country: 'Germany', airlines: 'Lufthansa, Condor', time: '8h 15m direct', img: 'https://images.pexels.com/photos/11104926/pexels-photo-11104926.jpeg?auto=compress&cs=tinysrgb&w=600' },
  { city: 'Zurich', code: 'ZRH', country: 'Switzerland', airlines: 'Swiss, Edelweiss Air', time: '8h direct', img: 'https://images.pexels.com/photos/28445206/pexels-photo-28445206.jpeg?auto=compress&cs=tinysrgb&w=600' },
  { city: 'Istanbul', code: 'IST', country: 'Turkey', airlines: 'Turkish Airlines', time: '6h direct', img: 'https://images.pexels.com/photos/13134869/pexels-photo-13134869.jpeg?auto=compress&cs=tinysrgb&w=600' },
  ...
  { city: 'Doha', code: 'DOH', country: 'Qatar', airlines: 'Qatar Airways', time: '5h 15m direct', img: 'https://images.pexels.com/photos/30852262/pexels-photo-30852262.jpeg?auto=compress&cs=tinysrgb&w=600' },
  { city: 'Abu Dhabi', code: 'AUH', country: 'UAE', airlines: 'Etihad Airways', time: '5h 30m direct', img: 'https://images.pexels.com/photos/5045851/pexels-photo-5045851.jpeg?auto=compress&cs=tinysrgb&w=600' },
  ...
  { city: 'Mumbai', code: 'BOM', country: 'India', airlines: 'Kenya Airways, Ethiopian', time: '5h 30m direct', img: 'https://images.pexels.com/photos/15528027/pexels-photo-15528027.jpeg?auto=compress&cs=tinysrgb&w=600' },
  ...
  { city: 'Guangzhou', code: 'CAN', country: 'China', airlines: 'Kenya Airways, Ethiopian', time: '12h (1 stop)', img: 'https://images.pexels.com/photos/14055760/pexels-photo-14055760.jpeg?auto=compress&cs=tinysrgb&w=600' },
  { city: 'Johannesburg', code: 'JNB', country: 'South Africa', airlines: 'Kenya Airways, South African Airways', time: '4h direct', img: 'https://images.pexels.com/photos/33622126/pexels-photo-33622126.jpeg?auto=compress&cs=tinysrgb&w=600' },
];
