  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert('Submission failed. Please try again or email us directly at bookings@catssafaris.com');
      }
    } catch {
      alert('Network error. Please try again or email us directly at bookings@catssafaris.com');
    }
  };
